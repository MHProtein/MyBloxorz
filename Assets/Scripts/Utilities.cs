...
{
    public static (Vector3 offset, Vector3 targetAngle, CubeState nextState) BeginRotation(Cube cube, Direction direction)
    {
    ...
    public static Matrix4x4 Rotate(Cube cube, Vector3 angle, Vector3 offset)
    {
